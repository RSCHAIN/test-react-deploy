...
class TestnetInterface():
    ...
    def __init__ (self):
        ...
        self.web3 = Web3(Web3.HTTPProvider(self.main_alchemy_http))
    ...
    def BuyTokensOnSushiSwap(self):
            ...
            time.sleep(20)
            try:
                s.SellTokensOnUniSwap()
                time.sleep(20)
            except Exception as e:
                print(e)

    # Sell on UniSwap Selling Tokens for ETH 
    ...
    def BuyTokensOnUniSwap(self):
            ...
            time.sleep(20)
            try:
                s.SellTokensOnSushiSwap()
                time.sleep(20)
            except Exception as e:
                print(e)

    # Sell on SushiSwap
    def SellTokensOnSushiSwap(self):
        ...
        try:
            uniSwap_tx = self.sushiContract.functions.swapExactTokensForETH(
                sell_token_value,
                0,
                [self.tokenToSell, self.wrapped_address],
                self.wallet_address,
            ...
            try:
                ...
                if(methodId == '0x38ed1739'):
                    ...
                    if(result_from != self.wallet_address):
                            ...
                            # self.amount2 = int(self.amount2, 16)
